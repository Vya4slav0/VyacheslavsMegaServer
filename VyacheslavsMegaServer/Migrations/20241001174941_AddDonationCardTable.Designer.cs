...
namespace VyacheslavsMegaServer.Migrations
{
    ...
    [Migration("20241001174941_AddDonationCardTable")]
    partial class AddDonationCardTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "21d2f81c-cdf0-430c-9c11-293f9d7d3a76",
                            Email = "vya4slav4617@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "VYA4SLAV4617@GMAIL.COM",
                            NormalizedUserName = "EVRAY",
                            PasswordHash = "AQAAAAIAAYagAAAAEA1KUDVzCn6c2xZ3lkXQmzd2yuGNcWtPJIt9Lglzmp/ZdIEFZ0niX21VxPyIoY++TA==",
                            PhoneNumber = "+7 (705) 806 3101",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c2a28b04-1b16-4923-8767-e6174676ad8a",
            ...
            modelBuilder.Entity("VyacheslavsMegaServer.Data.Entities.DonationCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ColorDownLeft")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<string>("ColorUpRight")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.HasKey("Id");

                    b.ToTable("DonationCards");
                });
            ...
            modelBuilder.Entity("VyacheslavsMegaServer.Data.Entities.Partner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VyacheslavsMegaServer.Data.Entities.PartnerLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VyacheslavsMegaServer.Data.Entities.PartnerLink", b =>
                {
                    b.HasOne("VyacheslavsMegaServer.Data.Entities.Partner", "Partner")
                        .WithMany("Links")
